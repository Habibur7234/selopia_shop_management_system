        ...
        if( $('#update_shop_form')[0].checkValidity() ) {
            ...
            $.ajax({
                ...
                success: function(){
                    ...
                    setTimeout(function () { $( supplier_table.row(rowIndex).nodes() ).removeClass( 'selected' ); }, 2000);
        ...
        if( $('#supplier_form')[0].checkValidity() ) {
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    setTimeout(function () { $( supplier_table.row(newRowIndex.index()).nodes() ).removeClass( 'selected' ); }, 2000);
